...
/*
 ...
 In this project we utilize algorithms for finding the mean, variance, and
 tandard deviation of a signal
*/
...
double CalcSignalSTD(double sig_variance);
...
int main(int argc, const char * argv[])
{
    ...
    signal_std = CalcSignalSTD(signal_variance);
    
    cout << "\nMean = " << signal_mean << endl;
    cout << "Variance = " << signal_variance << "\n";
    cout << "Standard Deviation = " << signal_std << "\n\n";
...
/*
 ...
 To find the standard deviation of the signal we simply find the
